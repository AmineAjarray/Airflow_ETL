...
def print_filename(**context):
  ...
  file = open("/home/kali/project/input_config.txt","w")
...
with airflow.DAG( "DAG", default_args= default_args, schedule_interval= "@once"  ) as dag:
    ...
    sensor_task = OmegaFileSensor(
      ...
      filepath="/home/kali/project/input/", #root path for checking
      filepattern=r"\b(\w*.csv)", #pattern used when checking domaine/date/file_json
    ...
    process_file_notebook = PapermillOperator(
        ...
        input_nb="/home/kali/project/process_input_list.ipynb",
        output_nb="/home/kali/project/outs/out-process_input_list{{ execution_date }}.ipynb",
